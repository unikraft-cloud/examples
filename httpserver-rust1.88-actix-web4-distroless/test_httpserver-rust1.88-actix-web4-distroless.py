"""End-to-end test for the ``httpserver-rust1.88-actix-web4-distroless`` example.

Mirrors the manual steps from ``httpserver-rust1.88-actix-web4-distroless/README.md``:

1. ``unikraft build . --output <prefix>/httpserver-rust188-actix-web4-distroless:<tag>``
...
def test_httpserver_rust_actix_serves_hello(build_image, run_instance, http, wait_instance):
    image = build_image("httpserver-rust1.88-actix-web4-distroless", "httpserver-rust1.88-actix-web4-distroless")
